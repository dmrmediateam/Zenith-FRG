...
export const metadata: Metadata = {
  ...
  description: "Your luxury home valuation request was received.",
...
export default function ThankYouQualifiedPage() {
  return (
    <>
      <ThankYouAnalytics outcome="qualified" />
      <Header />
      <main className="min-h-[70vh] bg-cream-100 pt-28 pb-20 px-6">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-stone-500 text-lg leading-relaxed font-sans font-light mb-10">
            Your request has been received. Gregg will review your information
            and be in touch personally within one business day.
          </p>
          <Link
            href="/"
